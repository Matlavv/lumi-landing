        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          <div className="col-span-1 md:col-span-2 space-y-6">
            <Link href="/" className="inline-block">
              <Image src="/logo_color_text.png" alt="Lumi Logo" width={100} height={32} className="dark:hidden h-8 w-auto" />
              <Image src="/logo_color_text_white.png" alt="Lumi Logo" width={100} height={32} className="hidden dark:block h-8 w-auto" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="mailto:contact@lumi-safety.com" className="text-zinc-600 dark:text-zinc-400 hover:text-lumi-violet dark:hover:text-lumi-violet transition-colors">Espace psychologues</a></li>
